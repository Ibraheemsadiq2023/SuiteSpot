        ...
        if self.var_contact.get() == "":
            ...
            try:
                ...
                if row is None:
                    ...
                    lbl_name=Label(showDataframe, text=row[1], font="arial 12 bold")
                    lbl_name.place(x=90,y=0)
                    ...
                    lbl_gender=Label(showDataframe,text=row[3],font="arial 12 bold")
                    lbl_gender.place(x=90,y=30)
                    ...
                    lbl_email=Label(showDataframe,text=row[6],font="arial 12 bold")
                    lbl_email.place(x=90,y=60)
                    ...
                    lbl_nationality=Label(showDataframe,text=row[7],font="arial 12 bold")
                    lbl_nationality.place(x=90,y=90)
                    ...
                    lbl_address=Label(showDataframe,text=row[10],font="arial 12 bold")
                    lbl_address.place(x=90,y=120)
                
                    # Update labels with fetched data
                    lbl_name.config( row[0])
                    lbl_gender.config( row[1])
                    lbl_email.config( row[2])
                    lbl_nationality.config( row[3])
                    lbl_address.config(row[4])
...
#=========================Fetch data============================
     ...
     def show_calendar_checkout(self, event, entry):
        top = Toplevel(self.root)
        cal = Calendar(top, selectmode='day', year=2024, month=4, day=8)
        cal.pack(fill='both', expand=True)
